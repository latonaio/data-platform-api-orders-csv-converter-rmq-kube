...
import (
	"bufio"
	"context"
	dpfm_api_input_reader "data-platform-api-orders-csv-converter-rmq-kube/DPFM_API_Input_Reader"
	dpfm_api_output_formatter "data-platform-api-orders-csv-converter-rmq-kube/DPFM_API_Output_Formatter"
	"data-platform-api-orders-csv-converter-rmq-kube/config"
	"io/ioutil"
	"os"
...
func (c *DPFMAPICaller) Orders(rmq *rabbitmq.RabbitmqClient, reader *dpfm_api_input_reader.FileReader, f *dpfm_api_input_reader.Request) error {
...
func (c *DPFMAPICaller) setHeaderData(ordersMessage *dpfm_api_output_formatter.DataConcatenation, f *dpfm_api_input_reader.Request, apiErr error) *dpfm_api_output_formatter.OrdersSDC {
	...
	return &dpfm_api_output_formatter.OrdersSDC{
		...
		ServiceLabel:        "FUNCTION_ORDERS_DATA_CONCATENATION",
		APIType:             f.APIType,
